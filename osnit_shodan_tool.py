...
@SHODAN AUTOMATION BY CYB3RLANT3RN@
'''
...
def custombanners(q):
	...
	for banner in connect.search_cursor(query):
		print(banner['data'])
		counter += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("-q", "--query", help="Enter the search string", type=str)
    parser.add_argument("-f", "--file", help="Name of file containing IPs", type=str)
